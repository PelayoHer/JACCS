    ...
    `;
        ...
        JACCS.Ascension = (function () {
            ...
            function _evaluateAscension() {
                ...
                let currentChips = Game.heavenlyChips || 1;
            ...
            const OPTIMAL_HEAVENLY_PATH = [
                ...
                'Tin of british tea biscuits', 'Heavenly luck', 'Permanent upgrade slot 1',
                'Heralds', 'Starter kit', 'Tin of butter cookies', 'Box of macarons',
                'Season switcher', 'Permanent upgrade slot 2', 'Starspawn', 'Starsnow',
                'Starter kitchen', 'Halo gloves', 'Kitten angels', 'Permanent upgrade slot 3',
                'Permanent upgrade slot 4', 'Permanent upgrade slot 5'
            ];
            ...
            /**
             * Handles the clicking logic inside the Ascension screen.
             */
            function _handleAscensionScreen() {
                ...
                if (Game.OnAscend && Game.AscendTimer === 0) {
                    ...
                    for (let s = 0; s < 5; s++) {
                        let slotUpgName = `Permanent upgrade slot ${s + 1}`;
